...
export class ForecastConditions implements Observer<WeatherData>, DisplayElement {
    ...
    display() {
        if (this._data) {
            console.log("Forecast looks bright for these conditions: " + JSON.stringify(this._data))
        }
    }
}